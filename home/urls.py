...
urlpatterns = [
    ...
    path("payment-details-admin", views.payment_details_admin, name='payment-details-admin'),
    path("showorders", views.showorders, name='showorders'),
    path("myorders", views.myorders, name='myorders'),
    path("checkout", views.checkout, name='checkout'),
    path("site-search", views.site_search, name='site-search'),
    path("download-invoice/<int:id>", views.download_invoice, name='download-invoice'),
